...
public class RegisterServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //desearilize request to a loginrequestbody java objeect
        RegisterRequestBody body = mapper.readValue(request.getReader(), RegisterRequestBody.class);
        MySQLConnection connection = new MySQLConnection();
        //initiallize the result response object
        ResultResponse resultResponse;
        //implement addUser command in the sql using the fields in the body we created
        //if true create new user, else output user already exists
        ...
        //use mapper to map resultResponse to json
